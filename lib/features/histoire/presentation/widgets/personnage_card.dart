...
class PersonnagesScreen extends ConsumerWidget {
        ...
        data: (personnages) => ListView.separated(
          ...
          itemBuilder: (context, index) {
            return PersonnageCard(
              ...
              onTap: () {
                _showPersonnageDetail(context, personnages[index]);
              },
            );
          },
        ),
  ...
  void _showPersonnageDetail(BuildContext context, personnage) {
